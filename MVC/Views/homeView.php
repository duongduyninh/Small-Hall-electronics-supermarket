...
<body>
    <div class="wrapper">
        <menu>
            ...
            <a href="tel:0967311513" class="action icon_phone"><i class="fa-solid fa-phone-volume"
    ...
    <script>
    if (window.location.pathname === '/MVC_LuanVan/home' || window.location.pathname === '/MVC_LuanVan/home/') {
        var defaultUrl = '/MVC_LuanVan/'; // Thay đổi thành URL mặc định của bạn
    ...
    <script src='/MVC_LUANVAN/Public/JS/Category_POST.js'></script>

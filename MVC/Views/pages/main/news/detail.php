<?php
$actual_link = (empty($_SERVER['HTTPS']) ? 'http' : 'https') . "://$_SERVER[HTTP_HOST]"."//MVC_LuanVan/"; 
$new = $data["new"];
?>
                                            ...
                                            <div class="list-group">
                                                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between text-right">
                                                        <img src="/MVC_LuanVan/Public/khoa/upload/tech_menu_19.jpg" alt="" class="img-fluid float-right">
                                            ...
                                            <div class="list-group">
                                                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between">
                                                        <img src="/MVC_LuanVan/Public/khoa/upload/tech_menu_20.jpg" alt="" class="img-fluid float-left">
                    ...
                    <div class="custombox authorbox clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <img src="/MVC_LuanVan/Public/khoa/upload/admin.png" alt="" class="img-fluid rounded-circle">
                            </div><!-- end col -->
                                ...
                                <div class="comments-list">
                                    <div class="media">
                                        <a class="media-left" href="#">
                                            <img src="/MVC_LuanVan/Public/khoa/upload/avatar_women.jpg" alt="" class="rounded-circle">
                                        </a>
                                    ...
                                    <div class="media">
                                        <a class="media-left" href="#">
                                            <img src="/MVC_LuanVan/Public/khoa/upload/avatar_nam.jpg" alt="" class="rounded-circle">
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="media last-child">
                                        <a class="media-left" href="#">
                                            <img src="/MVC_LuanVan/Public/khoa/upload/avatar_nam1.jpg" alt="" class="rounded-circle">
                                        </a>
                                        <div class="media-body">
            ...
            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                <div class="sidebar">
                    <div class="widget">
                        <div class="banner-spot clearfix">
                            <div class="banner-img">
                                <img src="/MVC_LuanVan/Public/khoa/images/banner_2.jpg" alt="" class="img-fluid">
                            </div><!-- end banner-img -->
                        </div><!-- end banner -->
                    </div><!-- end widget -->
                    ...
                    <div class="widget">
                        ...
                        <div class="blog-list-widget">
                            <div class="list-group">
                                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="/MVC_LuanVan/Public/khoa/images/OIG_8.jpg" alt="" class="img-fluid float-left">
                    ...
                    <div class="widget">
                        <div class="banner-spot clearfix">
                            <div class="banner-img">
                                <img src="/MVC_LuanVan/Public/khoa/images/anonymous.jpg" alt="" class="img-fluid">
                            </div><!-- end banner-img -->
                        </div><!-- end banner -->
                    </div><!-- end widget -->
                </div><!-- end sidebar -->
